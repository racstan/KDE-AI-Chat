...
├── tests/                        # Python test suite (172 test cases)
...
Refer to [CONTRIBUTING.md](CONTRIBUTING.md) for guidelines, testing workflows (including running the 172 python tests and QML linting), and style rules.
